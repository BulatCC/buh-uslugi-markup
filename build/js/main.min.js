...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_0__["burgerMenu"])();
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["initSliders"])();
  Object(_modules_validation__WEBPACK_IMPORTED_MODULE_2__["formValidation"])();
});
...
var formValidation = function formValidation() {
  ...
  var initTelMask = function initTelMask(inputTelNumber) {
    if (inputTelNumber) {
      inputTelNumber.addEventListener('mousedown', function () {
        Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(inputTelNumber, {
  ...
  if (forms[0]) {
    var validateTel = function validateTel(teltInput) {
      var isValid = true;
      if (teltInput) {
    ...
    forms.forEach(function (form) {
      ...
      var telInput = form.querySelector('[data-tel]');
